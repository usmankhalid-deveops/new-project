        ...
        <div className="flex items-center gap-3">
          ...
          {records.length > 0 && (
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-600 rounded-xl hover:bg-slate-200 transition-colors font-bold text-sm"
            ...
            >
              ...
              <div className="flex gap-2 mt-auto pt-4">
                <button 
                  ...
                  className="flex-1 py-3 border border-slate-200 rounded-xl flex items-center justify-center gap-2 text-sm font-bold text-slate-600 hover:bg-slate-50 transition-all active:scale-95"
                >
                  <Download size={16} /> 
                  Download Summary
                </button>
